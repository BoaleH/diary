...
import headerCloseIcon from "../../assets/images/Login/icon_close.png";
  ...
  private fetchSubmit = async () => {
    if (this.judgeCanSubmit()) {
      ...
      const params = {
        ...
        latitude: this.props.state.CommonReducer.addressObj.latitude,
        longitude: this.props.state.CommonReducer.addressObj.longitude,
        address: this.props.state.CommonReducer.addressObj.city + this.props.state.CommonReducer.addressObj.district,
      };
    ...
    return (
      <div className="login-page">
        <div className="header-close-icon">
          <img src={headerCloseIcon} alt="" onClick={this.goBack} />
        </div>
        {/* 登录弹窗 */}
        {
          !isShowGraghicAuth && <div className="login-box">
            <div className="header-logo">
              ...
              <div className="header-login-right">
                <div className="header-login-right-title">登录/注册</div>
                <div className="header-login-right-welcome">欢迎来到寻工鸟！</div>
              </div>
            </div>
            <div className="item">
        ...
        {/* 图形验证码弹窗 */}
        {
          isShowGraghicAuth && <div className="login-box">
            <div className="header-logo">
              <img src={logoIcon} alt=""/>
              <div className="header-login-right">
                <div className="header-login-right-title">图形验证</div>
                <div className="header-login-right-welcome">欢迎来到寻工鸟！</div>
              </div>
            </div>
            <div className="item">
